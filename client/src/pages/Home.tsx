  ...
  return (
    <div className="space-y-12 relative">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute top-20 left-10 w-96 h-96 bg-gradient-to-r from-cyan-500/30 to-blue-500/20 rounded-full filter blur-3xl animated-orb"></div>
        <div className="absolute -bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-purple-500/30 to-indigo-500/20 rounded-full filter blur-3xl animated-orb" style={{animationDelay: '2s'}}></div>
        <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-r from-blue-500/20 to-violet-500/20 rounded-full filter blur-3xl animated-orb" style={{animationDelay: '4s'}}></div>
      </div>
